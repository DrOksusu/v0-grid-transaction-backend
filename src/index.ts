...
import { agentManager, GridAgent, InfiniteBuyAgent, VRAgent, StablecoinArbAgent, CrossExchangeObserverAgent, MakerTakerSimulatorAgent, CrossExchangeArbAgent, PairScannerAgent, BithumbArbAgent } from './agents';
...
const startServer = async () => {
  try {
    ...
    httpServer.listen(config.port, async () => {
      ...
      console.log('[AgentManager] Agents registered (GridAgent, InfiniteBuyAgent, VRAgent, StablecoinArbAgent, CrossExchangeObserverAgent, MakerTakerSimulatorAgent, CrossExchangeArbAgent, PairScannerAgent, BithumbArbAgent)');
