...
import { agentManager, GridAgent, InfiniteBuyAgent, VRAgent, MakerTakerSimulatorAgent, PairScannerAgent, GeneralArbScannerAgent, UpbitListingMonitorAgent, BithumbListingMonitorAgent, BtcRsiAgent, RebalancerAgent, VolatilityBreakoutAgent, MultiExchangeArbAgent, InventoryArbAgent } from './agents';
...
const startServer = async () => {
  try {
    ...
    httpServer.listen(config.port, async () => {
      ...
      agentManager.register(new BithumbListingMonitorAgent());
      agentManager.register(new BtcRsiAgent());
      ...
      console.log('[AgentManager] Agents registered (GridAgent, InfiniteBuyAgent, VRAgent, MakerTakerSimulatorAgent, PairScannerAgent, GeneralArbScannerAgent, UpbitListingMonitorAgent, BithumbListingMonitorAgent, BtcRsiAgent, RebalancerAgent, VolatilityBreakoutAgent, MultiExchangeArbAgent, InventoryArbAgent)');
